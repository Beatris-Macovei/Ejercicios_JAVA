...
pepita = new Fraccion(2, 5, "Pepita");
Fraccion otra = new Fraccion(

System.out.println("Pepita = "+pepita.toString());

Fraccion robertita = new Fraccion(1, 5, "Robertita");
...
Fraccion maruja = new Fraccion(19,8, "Maruja");
Fraccion kiko = new Fraccion(8,7, "Kiko");
